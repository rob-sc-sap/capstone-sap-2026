...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "purchaseorders1/test/integration/FirstJourney",
    "purchaseorders1/test/integration/PurchaseOrdersListJourney",
    "purchaseorders1/test/integration/PurchaseOrdersObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
